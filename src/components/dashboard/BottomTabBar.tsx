...
import { HomeIcon, DocIcon, WarningIcon, CardIcon, DollarIcon } from "./icons";
...
export function BottomTabBar({
  ...
  return (
    ...
    >
      <div className="glass flex items-center gap-0.5 rounded-[28px] p-1.5 backdrop-blur-2xl backdrop-saturate-150">
        {DASHBOARD_TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex w-16 flex-col items-center gap-0.5 rounded-[20px] py-1.5 transition-all duration-200 active:scale-95 ${
                isActive
            ...
            >
              ...
              <span className={`text-[11px] ${isActive ? "font-semibold text-ink" : "font-medium"}`}>
                {tab.label}
              </span>
            </button>
          );
